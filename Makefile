...
DOCKER_CMD := docker run -t --rm -e CLUSTER_NAME -e CLIENT_TEST_E2E_USER_NAME -e CLIENT_TEST_E2E_USER_NAME_ALT -e CLIENT_TEST_E2E_AUTH_URI -e CLIENT_TEST_E2E_ADMIN_URI -e CLIENT_TEST_E2E_API_URI $(IMAGE_NAME):$(IMAGE_TAG)
