...
CLIENT_TEST_E2E_URI=${CLIENT_TEST_E2E_URI:-https://dev.neu.ro}
export CLIENT_TEST_E2E_AUTH_URI=${CLIENT_TEST_E2E_AUTH_URI:-CLIENT_TEST_E2E_URI}
export CLIENT_TEST_E2E_ADMIN_URI=${CLIENT_TEST_E2E_ADMIN_URI:-CLIENT_TEST_E2E_URI}
export CLIENT_TEST_E2E_API_URI=${CLIENT_TEST_E2E_API_URI:-CLIENT_TEST_E2E_URI}
